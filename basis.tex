  ...
  \begin{itemize}
    ...
    \item 编辑器
      ...
      \begin{itemize}
        ...
        \item VS Code：配置 |tools| 和 |recipes| 使用扩展 LaTeX Workshop
    
      \end{itemize}
  \end{itemize}
\end{frame}

\begin{frame}[fragile]{VS Code setting}
  \begin{itemize}
    \item "editor.fontSize": 16,
    \item "editor.wordWrap": "on",
    \item "latex-workshop.latex.autoBuild.run": "never"
  \end{itemize}
...
\item Snip \link{https://mathpix.com/} 图片转 \LaTeX{} 公式 (推荐)
\item tablesgenerator.com/ \link{http://www.tablesgenerator.com/} 等在线表格生成网站（表格部分乱入）
\end{itemize}
\end{frame}
...
\bigskip
  ...
  \begin{minipage}{0.7\linewidth}
    \begin{lstlisting}
清华大学校徽请参见图~\ref{fig:lib}。
\begin{figure}[htbp]
  \centering
  \includegraphics[height=.2\textheight]{Tsinghua.png}
  \caption{清华大学校徽。}
  \label{fig:lib}
\end{figure}
\end{lstlisting}
  ...
  \begin{minipage}{0.3\linewidth}\centering
    {\songti 清华大学校徽请参见图~1。}\\[1em]
 \includegraphics[height=0.2\textheight]{Tsinghua.png}\\
 {\footnotesize\heiti 图~1. 清华大学校徽。}
  \end{minipage}
\end{frame}
